# Antic Didone Font | (Holloway) Chew, Kean Ho's Creative Visuals

[![banner](/Pictures/banner_1200x630.svg)](#)

Antic Didone is a Latin (ID: `*Latn`) Serif font designed by
[The Antic Didone Project Team](https://github.com/librefonts/anticdidone). Its
design is based on Didone font family with rhythmic and dynamic typography for
headlines usage in newspapers and magazines.
...
```
Title: Antic Didone Font
Creators: The Antic Didone Project Team
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-antic-didone
UUID: E357E88C-C6C3-48F9-B157-760866906A1B
...
Procure: https://github.com/ChewKeanHo/visuals-fonts-antic-didone
```
